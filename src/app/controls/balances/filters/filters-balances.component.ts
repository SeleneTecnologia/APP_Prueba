...
@Component({
  selector: 'app-filters-balances',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './filters-balances.component.html',
  styleUrl: './filters-balances.component.css'
})
export class FiltersbalancesComponent  implements OnInit, OnDestroy {
  name: string = '';
  fromDate: string = '';
  toDate: string = '';
  loadStatusId: string = '';
